# exons
awk '$3 == "exon"' ${annotation} | sort -k1,1 -k4,4n | mergeBed -i stdin -c 7 -o distinct | awk -v OFS="\t" '$(NF+1)="exon"' > exons
# genes
awk '$3 == "gene"' ${annotation} | sort -k1,1 -k4,4n | mergeBed -i stdin -c 7 -o distinct | awk -v OFS="\t" '$(NF+1)="gene"' > genes
# introns
